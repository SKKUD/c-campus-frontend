...
const OpenMessage = ({MessageNumber}: IOpenMessage) => {
  ...
  return (
    <>
      <OpenMessageHeader>
        <OpenMessageHeaderContent>{MessageNumber}개의 공개쪽지</OpenMessageHeaderContent>
      </OpenMessageHeader>
          ...
          OpenMessageDataSet.map((OpenMessageData) => {
            return (
              <OpenMessageContent key={OpenMessageData.id} color={OpenMessageData.color}>
                ...
                <OpenMessageContentSender>From. {OpenMessageData.sender}</OpenMessageContentSender>
              </OpenMessageContent>
            )
          })
        }
